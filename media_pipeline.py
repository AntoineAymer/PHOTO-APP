...
_DEFAULT_PROMPTS = {
    "shadow": (
        ...
        "1. Extract the COMPLETE outline of the identified person — this includes their ENTIRE body, "
        "ALL clothing (shirts, pants, dresses, hats, scarves), hair, shoes, and any held objects\n"
        "2. **CRITICAL: The silhouette must occupy the EXACT SAME pixel position as the original person.** "
        "Do NOT move, shift, resize, or reposition the silhouette. Every pixel of the silhouette must "
        "overlap exactly where the original person's pixels were. The image dimensions and all pixel "
        "coordinates must remain identical.\n"
        "3. Fill the ENTIRE area inside the outline with solid pure black (#000000) — "
        "no clothing colors, no skin, no hair texture should remain visible\n"
        "4. The silhouette must be a completely opaque black shape — like painting over the person "
        "with black paint directly on the photo, in place, without moving anything\n\n"
        "**Phase 3: Preservation Verification**\n"
        "1. Verify the silhouette is in the EXACT same position as the original person — not shifted even 1 pixel\n"
        "2. Verify all other people remain at original visibility and position\n"
        "3. Verify background elements unchanged\n"
        "4. Verify the output image has the exact same dimensions as the input\n"
        "5. Verify no darkening or modifications to non-target areas\n\n"
        "## REQUIREMENTS\n\n"
        "**You must:**\n"
        "- Replace ONLY the person matching the description\n"
        "- The silhouette MUST be at the EXACT SAME POSITION as the original person — zero displacement\n"
        "- Use solid pure black (#000000) for the ENTIRE silhouette — head, hair, face, body, "
        "ALL clothing, shoes, accessories, and any objects they are holding\n"
        "- The result must look like a solid black cutout — NO clothing colors, textures, or patterns should remain\n"
        "- Follow the target person's exact body outline including clothes\n"
        ...
        "- Output image must have the EXACT same dimensions as input\n"
        "- Output only the edited image\n\n"
        "**You must not:**\n"
        "- Move, shift, or reposition the silhouette — it must be exactly where the person was\n"
        "- Leave any part of the person's clothing, skin, or hair visible — everything must be pure black\n"
        ...
        "- Change the image dimensions or crop\n\n"
        "## VERIFICATION CHECKLIST\n"
        "Before output, verify:\n"
        "- Correct person identified from description\n"
        "- Silhouette applied to ONLY that one person\n"
        "- The ENTIRE person is pure black (#000000) — no clothing colors, skin, or hair visible\n"
        "- The silhouette looks like a solid black shadow/cutout shape\n"
